  ...
  const items = [
    {
      ...
      text: "En tant qu&apos;entrepreneur actif, je vous apporte une vision actuelle et à 360° du marché du tourisme. Mon objectif est de faire évoluer le secteur avec pragmatisme et modernité.",
      borderColor: "#feb516",
    },
    {
      title: "L'engagement terrain",
      text: "Je suis engagé au quotidien auprès des professionnels du voyage. En tant que membre du Comité des adhésions de l&apos;APST et délégué régional, j&apos;accompagne les futurs acteurs du tourisme avec énergie et réalisme.",
      borderColor: "#000000",
    },
    {
      title: "Une passion pour l'entrepreneuriat",
      text: "Je suis un entrepreneur passionné. J&apos;aime aller au bout des dossiers, les traiter avec rigueur et humanité. Mon approche repose sur l&apos;écoute et l&apos;efficacité.",
      borderColor: "#000000",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
          <motion.div variants={itemVariants} className="space-y-4 md:space-y-8">
            <div className="flex flex-row items-center gap-6">
              ...
              />
              <h2 className="w-full text-center md:text-left text-2xl lg:text-3xl xl:text-4xl font-bold tracking-tight -ml-2">
          ...
          <div className="h-full flex flex-col justify-between gap-4 lg:gap-6">
            {items.map((item, index) => (
              <motion.div
                ...
                className="border-b-8 pb-6 sm:border-l-8 sm:pl-6 cursor-pointer py-2 transition-all duration-300 ease-in-out"
                style={{
                  borderColor: item.borderColor,
                  backgroundColor: activeIndex === index ? "#fff5e5" : "transparent",
                }}
              >
                <h3 className="font-semibold text-md lg:text-xl mb-3">
                  {item.title}
                </h3>
                <p
                  className="text-muted-foreground text-sm max-w-xl mr-auto"
